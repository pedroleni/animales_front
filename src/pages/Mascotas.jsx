...
const Mascotas = () => {
  ...
  return (
    <section>
      ...
      <div className="title_pets"><img src="./images/mascotas_white.gif" alt="titulo_pet" /></div>
      <div className="title_pets_black"><img src="./images/mascotas_black.gif" alt="titulo_pet" /></div>
